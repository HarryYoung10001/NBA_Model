...
# 读取三个CSV文件
potential_results = pd.read_csv('/mnt/project/potential_results.csv')
commercial_score = pd.read_csv('/mnt/project/league_commercial_score.csv')
athletic_salary = pd.read_csv('/mnt/project/athetic-salary.csv')
...
# 保存到CSV
output_path = '/mnt/user-data/outputs/merged_player_data.csv'
